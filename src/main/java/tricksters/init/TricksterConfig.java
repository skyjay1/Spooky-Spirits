...
public final class TricksterConfig {
	...
	public static final TricksterConfig CONFIG = new TricksterConfig(BUILDER);
	...
	public TricksterConfig(final ForgeConfigSpec.Builder builder) {
		Tricksters.LOGGER.info(Tricksters.MODID + ": Building Config");
		builder.push("wisp");
